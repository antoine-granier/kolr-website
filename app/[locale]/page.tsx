    ...
    <>
          ...
          <Reveal animation="reveal-up">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-kolr-text-muted max-w-[700px] mx-auto">
                Powerful features designed for creators, designers, and color
                enthusiasts
              </p>
            </div>
          </Reveal>
      ...
      <section className="section">
        <div className="container">
          <Reveal animation="reveal-up">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-black mb-4">Try Our Free Tools</h2>
              <p className="text-xl text-kolr-text-muted max-w-[700px] mx-auto">
                Explore color palettes, harmonies, and extraction tools right in
                your browser
              </p>
            </div>
          </Reveal>
          ...
          <Reveal animation="reveal-up">
            <div className="bg-white/[0.03] border border-white/[0.08] rounded-[3rem] p-12 md:p-16 text-center backdrop-blur-xl">
              ...
              <p className="text-xl text-kolr-text-muted mb-12 max-w-[600px] mx-auto">
                Download Kolr today and transform the way you work with colors.
